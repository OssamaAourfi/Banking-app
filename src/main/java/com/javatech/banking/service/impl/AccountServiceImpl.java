package com.javatech.banking.service.impl;

import com.javatech.banking.dto.AccountDto;
import com.javatech.banking.entity.Account;
import com.javatech.banking.mapper.AccountMapper;
import com.javatech.banking.repository.AccountRepository;
...
public class AccountServiceImpl implements AccountService {
    ...
    public AccountDto deposit(Long id, double amount) {
        Account account = accountRepository
                .findById(id)
                .orElseThrow(()->new RuntimeException("Accounr does not exists"));
